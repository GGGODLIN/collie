# 0070 — Claude operator commands join the reference catalog

- **Status:** Accepted; command execution amended by [ADR 0071](./0071-the-agent-palette-stages-never-sends.md)
- **Date:** 2026-09-23
- **Shipped in:** pending

...
export const ja: Dictionary = {
  ...
  "retell.plain": "かみくだく",
  "retell.lost": "話を見失った",
  "retell.loading": "言い直しを作成中 — 1 分ほどかかることがあります",
  "retell.failed": "このセッションを言い直せませんでした",
  "retell.cached": "共有キャッシュから",
  "retell.again": "もう一度",
  "paneActions.account.label": "アカウントを切り替え",
  "paneActions.account.back": "戻る",
  "paneActions.account.switching": "{account} に切り替え中…",
  "paneActions.account.confirmInterrupt": "もう一度タップ：このターンを中断して {account} に切り替え",
  "paneActions.account.done": "{account} で再開しました",
  "paneActions.account.failed": "アカウントを切り替えられませんでした",
  ...
  "apiError.account.not_allowlisted": "そのアカウントは accounts.toml にありません",
  "apiError.account.not_claude": "このペインには再開できる Claude セッションがありません",
  "apiError.account.confirm_interrupt": "エージェントが作業中です — このターンの中断を確認してください",
  "apiError.account.in_progress": "このペインではすでに切り替え中です",
  "apiError.account.no_transcript": "このセッションにはまだ記録がありません — 先にメッセージを 1 つ送ってください",
  "apiError.account.settings_pending": "前回の回答後にモデルか effort が変わりました — 先にメッセージを 1 つ送ってください",
  "apiError.account.exit_failed": "{reason}",
  "apiError.account.exit_unconfirmed": "Claude の終了を確認できなかったため、何も起動していません — ペインを確認してください",

...
export const zhTW: Dictionary = {
  ...
  "retell.plain": "白話",
  "retell.lost": "跟丟了",
  "retell.loading": "正在產生重講，可能要一分鐘",
  "retell.failed": "無法重講這個 session",
  "retell.cached": "來自共用快取",
  "retell.again": "重新產生",
  "paneActions.account.label": "切換帳號",
  "paneActions.account.back": "返回",
  "paneActions.account.switching": "正在切換到 {account}…",
  "paneActions.account.confirmInterrupt": "再按一次：打斷這一輪並切換到 {account}",
  "paneActions.account.done": "已在 {account} 接續",
  "paneActions.account.failed": "無法切換帳號",
  ...
  "apiError.account.not_allowlisted": "這個帳號不在你的 accounts.toml 裡",
  "apiError.account.not_claude": "此窗格沒有可接續的 Claude session",
  "apiError.account.confirm_interrupt": "agent 正在工作，請確認要打斷這一輪",
  "apiError.account.in_progress": "此窗格已有一個切換正在進行",
  "apiError.account.no_transcript": "這個 session 還沒有對話紀錄，請先送一則訊息",
  "apiError.account.settings_pending": "上次回答後改過模型或 effort，請先送一則訊息",
  "apiError.account.exit_failed": "{reason}",
  "apiError.account.exit_unconfirmed": "Claude 沒有確認已結束，所以沒有啟動新的程序，請查看窗格",

...
export const ko: Dictionary = {
  ...
  "retell.plain": "쉽게",
  "retell.lost": "놓쳤어요",
  "retell.loading": "다시 설명을 작성 중 — 1분 정도 걸릴 수 있습니다",
  "retell.failed": "이 세션을 다시 설명하지 못했습니다",
  "retell.cached": "공유 캐시에서",
  "retell.again": "다시 요청",
  "paneActions.account.label": "계정 전환",
  "paneActions.account.back": "뒤로",
  "paneActions.account.switching": "{account}(으)로 전환 중…",
  "paneActions.account.confirmInterrupt": "한 번 더 탭: 이번 턴을 중단하고 {account}(으)로 전환",
  "paneActions.account.done": "{account}에서 이어서 진행",
  "paneActions.account.failed": "계정을 전환하지 못했습니다",
  ...
  "apiError.account.not_allowlisted": "그 계정은 accounts.toml에 없습니다",
  "apiError.account.not_claude": "이 창에는 이어갈 수 있는 Claude 세션이 없습니다",
  "apiError.account.confirm_interrupt": "에이전트가 작업 중입니다 — 이번 턴 중단을 확인하세요",
  "apiError.account.in_progress": "이 창에서 이미 전환이 진행 중입니다",
  "apiError.account.no_transcript": "이 세션에는 아직 기록이 없습니다 — 먼저 메시지를 하나 보내세요",
  "apiError.account.settings_pending": "마지막 답변 이후 모델이나 effort가 바뀌었습니다 — 먼저 메시지를 하나 보내세요",
  "apiError.account.exit_failed": "{reason}",
  "apiError.account.exit_unconfirmed": "Claude가 종료를 확인하지 않아 아무것도 시작하지 않았습니다 — 창을 확인하세요",

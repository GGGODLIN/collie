...
export const de: Dictionary = {
  ...
  "retell.plain": "Einfach erklärt",
  "retell.lost": "Den Faden verloren",
  "retell.loading": "Die Nacherzählung wird geschrieben — das kann eine Minute dauern",
  "retell.failed": "Diese Sitzung konnte nicht nacherzählt werden",
  "retell.cached": "Aus dem gemeinsamen Cache",
  "retell.again": "Neu anfragen",
  "paneActions.account.label": "Konto wechseln",
  "paneActions.account.back": "Zurück",
  "paneActions.account.switching": "Wechsle zu {account}…",
  "paneActions.account.confirmInterrupt": "Nochmal tippen: diesen Turn abbrechen und zu {account} wechseln",
  "paneActions.account.done": "Weiter auf {account}",
  "paneActions.account.failed": "Konto konnte nicht gewechselt werden",
  ...
  // --- crew ---
  "crew.title": "Crew",
  "crew.nav.back": "Zurück",
  "crew.entry.title": "Crew-Übersicht",
  "crew.entry.description": "Status aller Rechner in der Crew.",
  "crew.footer.label": "Crew · {machines} · {reachable}",
  "crew.footer.aria": "Crew-Übersicht öffnen",
  "crew.summary.counts": "{machines} · {reachable}",
  "crew.summary.machines.one": "{count} Rechner",
  "crew.summary.machines.other": "{count} Rechner",
  "crew.summary.reachable": "{count} erreichbar",
  "crew.summary.deputy": "Deputy",
  "crew.summary.noDeputy": "Kein Deputy benannt",
  "crew.summary.warrant": "Vollmacht {generation}",
  "crew.summary.secret": "Geheimnis",
  "crew.summary.secretValue": "Generation {generation} · rotiert {time}",
  "crew.member.health": "Status",
  "crew.member.reason": "Ursache",
  "crew.member.conflict": "Konflikt",
  "crew.member.conflictValue": "{lead} führt ebenfalls · Vollmacht {generation}",
  "crew.member.conflictNoWarrant": "{lead} führt ebenfalls · keine Vollmacht",
  "crew.member.version": "Version",
  "crew.member.versionDiffers": "Weicht vom Lead ab",
  "crew.member.address": "Adresse",
  "crew.member.enrolled": "Registriert",
  "crew.member.secretBehind": "Hat das aktuelle Secret noch nicht übernommen.",
  "crew.member.provisional": "Registriert, aber nie erreicht.",
  "crew.health.reachable": "erreichbar",
  "crew.health.unreachable": "nicht erreichbar",
  "crew.health.incompatible": "inkompatibel",
  "crew.health.conflicted": "im Konflikt",
  "crew.role.deputy": "Deputy",
  "crew.sheet.goTo": "Zu diesem Rechner",
  "crew.formation.aria": "Crew-Aufstellung: {machines}",
  "crew.node.aria": "{name}, {role}, {health}",
  "crew.node.ariaPlain": "{name}, {health}",
  "crew.solo.title": "Dieser Collie führt keine Crew",
  "crew.solo.description": "Crews werden über die Kommandozeile erstellt und verwaltet.",
  "crew.error.title": "Crew-Status konnte nicht geladen werden",
  ...
  "apiError.account.not_allowlisted": "Dieses Konto steht nicht in deiner accounts.toml",
  "apiError.account.not_claude": "In diesem Pane läuft keine Claude-Sitzung, die Collie fortsetzen kann",
  "apiError.account.confirm_interrupt": "Der Agent arbeitet — bestätige, dass dieser Turn abgebrochen wird",
  "apiError.account.in_progress": "In diesem Pane läuft bereits ein Wechsel",
  "apiError.account.no_transcript": "Diese Sitzung hat noch kein Protokoll — sende zuerst eine Nachricht",
  "apiError.account.settings_pending": "Modell oder Effort wurden nach der letzten Antwort geändert — sende zuerst eine Nachricht",
  "apiError.account.exit_failed": "{reason}",
  "apiError.account.exit_unconfirmed": "Claude hat das Beenden nicht bestätigt, daher wurde nichts gestartet — prüfe das Pane",
  ...
  "settings.updateCard.checking": "Rechner wird geprüft…",
  ...
  "settings.updateCard.urgent": "Dringend",
  "settings.updateCard.urgentSince": "Dringend seit {version}",
  "settings.updateCard.linkChange": "Ändert die Crew-Verbindung. Zuerst den Lead aktualisieren, die Mitglieder folgen.",
  ...
  "settings.updateCard.startingSlow": "Wird noch gestartet. Der Host hat den Lauf noch nicht gemeldet.",
  ...
  "settings.updateCard.phaseOf": "Schritt {step} von {total}",
  "settings.updateCard.state.restartingSlow": "Der Neustart dauert ungewöhnlich lange. Dienst auf dem Rechner prüfen.",
  ...
  // --- M16/01: the updates page, its crew lines and the Settings row ---
  "settings.updateCard.retryCrew": "Crew-Update wiederholen",
  "settings.updateCard.actionAll": "Alle Maschinen auf {version} aktualisieren",
  "settings.updateCard.retryOne": "{name} erneut versuchen",
  "settings.updateCard.retryNow": "Jetzt wiederholen",
  "settings.updateCard.crewConfirmTitle": "Crew auf {version} aktualisieren?",
  "settings.updateCard.crewConfirmBody": "Diese Maschine beginnt. Danach aktualisiert sich jedes Crew-Mitglied selbst auf dieselbe Version, prüft den eigenen Zustand und setzt sich bei Fehlern selbstständig zurück.",
  "settings.updateCard.crewConfirmAction": "Ja, Crew aktualisieren",
  "settings.updateCard.retryConfirmTitle": "Crew-Update wiederholen?",
  ...
  "settings.updateCard.peers.label": "Crew-Mitglieder",
  "settings.updateCard.crewPatience": "Nichts tun, das läuft von allein durch.",
  ...
  "settings.updateCard.peer.movingFor": "seit {elapsed}",
  ...
  "updates.entry.title": "Aktualisierungen",
  "updates.entry.description": "Collie und die Crew aktualisieren.",
  ...
  "updateRibbon.peersSlow.one": "Update ({count}): {names}, {elapsed}",
  "updateRibbon.peersSlow.other": "Update ({count}): {names}, {elapsed}",
  "updateRibbon.underAMinute": "< 1 Min.",
  ...
  "updateScreen.title": "Collie wird aktualisiert",
  "updateScreen.close": "Schließen",
  "updateScreen.rows.label": "Maschinen",
  "updateScreen.thisMachine": "Diese Maschine",
  "updateScreen.versionUnknown": "eine unbekannte Version",
  "updateScreen.reasonUnknown": "kein Grund angegeben",
  "updateScreen.seeUpdates": "Aktualisierungen ansehen",
  "updateScreen.keepWaiting": "Weiter warten",
  "updateScreen.truth": "Die Aktualisierung läuft auf den Maschinen. Dieser Bildschirm zeigt sie nur an, und das Schließen der App stoppt sie nicht.",
  "updateScreen.badge.moving": "{name}: {word}",
  "updateScreen.badge.downloading": "Die neue App wird heruntergeladen",
  "updateScreen.badge.generic": "Aktualisierung läuft",
  "updateScreen.state.preflight": "prüfen",
  "updateScreen.state.staging": "bauen",
  "updateScreen.state.restarting": "neustarten, gleich zurück",
  "updateScreen.state.verifying": "die neue Version wird geprüft",
  "updateScreen.state.done": "fertig",
  "updateScreen.state.rolledBack": "zurück auf {version}",
  "updateScreen.state.stuck": "hängt",
  "updateScreen.state.interrupted": "unterbrochen",
  "updateScreen.state.idle": "inaktiv",
  "updateScreen.state.waiting": "wartet",
  "updateScreen.state.updating": "wird aktualisiert",
  "updateScreen.state.unreachable": "keine Antwort",
  "updateScreen.state.packageManaged": "paketverwaltet",
  "updateScreen.state.current": "bereits aktuell",
  "updateScreen.peer.lastSeen": "zuletzt vor {ago} gesehen",
  "updateScreen.peer.packageManagedNote": "Der Paketmanager verwaltet diese Maschine, daher wird sie beim Durchlauf ausgelassen.",
  "updateScreen.failed.rolledBack": "Das Update wurde zurückgesetzt. Diese Maschine verwendet weiterhin {version}: {reason}",
  "updateScreen.failed.stuck": "Das Update hängt: {reason}",
  "updateScreen.failed.interrupted": "Das Update wurde unterbrochen: {reason}",
  "updateScreen.lead.stalled": "Arbeitet noch. Bisher liegt kein Fehler vor, und Warten ist die einzige Aufgabe.",
  ...
  "updateScreen.device.title": "Dieses Gerät",
  "updateScreen.device.downloading": "Neue App wird heruntergeladen, {done} von {total} Dateien",
  "updateScreen.device.downloadingUnknown": "Neue App wird heruntergeladen",
  "updateScreen.device.switching": "Wechsel zur neuen App",
  "updateScreen.device.progressAria": "Dateien heruntergeladen",
  "updateScreen.device.hung": "Wird noch heruntergeladen. Verwenden Sie die App weiter; sie wechselt automatisch, sobald der Download abgeschlossen ist.",
  "updateScreen.device.keepUsing": "App weiternutzen",
  "updateScreen.done.crew": "Crew auf {version} aktualisiert",
  "updateScreen.done.solo": "{machine} auf {version} aktualisiert",
  ...
  "updateScreen.band.step": "Aktualisierungsmodus · Schritt {step} von {total}",
  "updateScreen.band.done": "Aktualisierung abgeschlossen",
  "updateScreen.band.stopped": "Aktualisierung angehalten",
  "updateScreen.lock": "Die App ist gesperrt, bis dieser Vorgang abgeschlossen ist. Terminalsitzungen und Agenten laufen weiter.",
  "updateScreen.phone": "Dieses Smartphone",
  "updateScreen.thisPhone": "dieses Smartphone",
  "updateScreen.list.two": "{a} und {b}",
  "updateScreen.list.many": "{head} und {last}",
  "updateScreen.action.start": "Aktualisierung starten",
  "updateScreen.action.notNow": "Nicht jetzt",
  "updateScreen.action.back": "Zurück zur App",
  "updateScreen.action.escape": "Die App trotzdem verwenden",
  "updateScreen.action.skip": "{name} überspringen",
  "updateScreen.action.keepTrying": "Weiter versuchen",
  "updateScreen.action.retryOne": "{name} erneut versuchen",
  "updateScreen.action.retryMany.one": "{count} Maschine erneut versuchen",
  "updateScreen.action.retryMany.other": "{count} Maschinen erneut versuchen",
  "updateScreen.action.tryAgain": "Erneut versuchen",
  "updateScreen.action.showLog": "Protokoll anzeigen",
  "updateScreen.action.copy": "Kopieren",
  "updateScreen.action.copied": "Kopiert",
  "updateScreen.strip.mine": "Update läuft. {step}.",
  "updateScreen.strip.other": "Update läuft, auf einem anderen Gerät gestartet. {step}.",
  "updateScreen.strip.view": "Anzeigen",
  "updateScreen.ready.heading": "Auf {version} aktualisieren",
  "updateScreen.ready.majorHeading": "Zu {version} wechseln",
  "updateScreen.ready.majorSubtitle": "{version} ist eine neue Hauptversion und erfordert daher einen eigenen Start. Lesen Sie zuerst die Versionshinweise.",
  "updateScreen.ready.crew.one": "{count} Maschine und dieses Smartphone, nacheinander.",
  "updateScreen.ready.crew.other": "{count} Maschinen und dieses Smartphone, nacheinander.",
  "updateScreen.ready.solo": "{lead} und dieses Smartphone, nacheinander.",
  "updateScreen.ready.retryOne": "{name} erneut versuchen",
  "updateScreen.ready.retryMany": "Die anderen Maschinen auf {version} aktualisieren",
  "updateScreen.ready.retrySubtitle": "{lead} führt bereits {version} aus. Nur die anderen Maschinen werden aktualisiert.",
  "updateScreen.ready.lead": "baut, startet dann neu",
  "updateScreen.ready.leadNote": "Die Verbindung wird für bis zu 30 Sekunden unterbrochen.",
  "updateScreen.ready.member": "wird als Nächstes aktualisiert",
  "updateScreen.ready.memberRetry": "aktualisiert auf {version}",
  "updateScreen.ready.memberNote": "Kehrt automatisch zurück, wenn die Prüfung fehlschlägt.",
  "updateScreen.ready.phone": "lädt am Ende neu",
  "updateScreen.ready.phoneNote": "Einmal, auf die neue App.",
  "updateScreen.ready.note": "Während der Ausführung ist die App auf diesem Telefon gesperrt. Terminalsitzungen und Agenten laufen weiter.",
  "updateScreen.ready.noteCrewOnly": "Während der Ausführung ist die App auf diesem Telefon gesperrt. Dieses Telefon behält seine App.",
  "updateScreen.check.heading": "{lead} wird überprüft",
  "updateScreen.check.subtitle": "Festplatte, Dienst und Build-Tools. Ungefähr 10 Sekunden.",
  "updateScreen.check.next": "Als Nächstes: {lead} baut {version}.",
  "updateScreen.build.heading": "{version} wird auf {lead} gebaut",
  "updateScreen.build.subtitle": "Abrufen und Kompilieren. Die alte Version läuft bis zum Wechsel weiter.",
  "updateScreen.build.next": "Als Nächstes: {lead} startet neu. Die Verbindung wird für bis zu 30 Sekunden unterbrochen.",
  "updateScreen.restart.heading": "{lead} startet neu",
  "updateScreen.restart.subtitle": "Die Verbindung ist absichtlich getrennt. Das Update läuft weiter, und dieser Bildschirm nimmt es wieder auf.",
  "updateScreen.restart.next": "In etwa 15 Sekunden wieder da. Dann überprüft {lead} die neue Version.",
  "updateScreen.verify.heading": "Die neue Version auf {lead} wird überprüft",
  "updateScreen.verify.subtitle": "Wenn die Prüfung fehlschlägt, kehrt {lead} von selbst zu {from} zurück.",
  "updateScreen.verify.nextMembers": "Als Nächstes: die anderen Maschinen, nacheinander.",
  "updateScreen.verify.nextPhone": "Als Nächstes: Dieses Telefon lädt die neue App.",
  "updateScreen.members.heading": "Die anderen Maschinen werden aktualisiert",
  "updateScreen.members.subtitle": "Nacheinander, damit ein fehlerhafter Build bei einer Maschine stoppt.",
  "updateScreen.members.next": "Dann lädt dieses Telefon die neue App und lädt einmal neu.",
  "updateScreen.members.nextCrewOnly": "Dieses Telefon behält seine App. Hier wird nichts neu geladen.",
  "updateScreen.phone.heading": "Dieses Telefon wird aktualisiert",
  "updateScreen.phone.subtitle": "Die neue App wird heruntergeladen: {done} von {total} Dateien.",
  "updateScreen.phone.looking": "Die neue App wird von {lead} abgerufen.",
  "updateScreen.phone.hung": "Keine neue Datei seit 2 Minuten. Sie können die vorhandene App weiter verwenden.",
  "updateScreen.phone.next": "Dann lädt der Bildschirm einmal neu, und diese Ansicht kehrt von selbst zurück.",
  "updateScreen.switch.heading": "Dieses Telefon wird auf {version} umgestellt",
  "updateScreen.switch.subtitle": "Der Bildschirm lädt einmal neu. Schließen Sie die App nicht. Diese Ansicht kehrt von selbst zurück.",
  "updateScreen.done.heading": "Update abgeschlossen",
  "updateScreen.done.arrived.one": "{names} führt {version} aus.",
  "updateScreen.done.arrived.other": "{names} führen {version} aus.",
  "updateScreen.done.behind.one": "{names} wurde nicht aktualisiert.",
  "updateScreen.done.behind.other": "{names} wurde nicht aktualisiert.",
  "updateScreen.rolledBack.heading": "{lead} ist auf {from} zurückgekehrt",
  "updateScreen.rolledBack.subtitle": "Die neue Version hat die Prüfung nicht bestanden. {lead} führt {from} aus und funktioniert normal. Sonst hat sich nichts geändert.",
  "updateScreen.stuck.heading": "Das Update wurde auf {lead} angehalten",
  "updateScreen.stuck.subtitle": "Es wurde weder abgeschlossen noch automatisch zurückgesetzt. Terminalsitzungen laufen weiter. Führen Sie dies auf {lead} aus:",
  "updateScreen.stopped.subtitle": "Es wurde vor dem Abschluss angehalten. Nichts blieb halb installiert zurück. {lead} führt weiterhin {from} aus.",
  "updateScreen.failed.heading": "Das Update ist auf {lead} fehlgeschlagen",
  "updateScreen.failed.subtitle": "Es wurde nichts geändert. Auf {lead} läuft weiterhin {from}. Der Grund ist unten angegeben.",
  "updateScreen.ask.quiet": "{name} antwortet seit {elapsed} nicht. Sie können dies überspringen.",
  "updateScreen.ask.limited": "{name} wartet das Einmal-pro-Stunde-Limit ab. Sie können dies überspringen.",
  "updateScreen.row.on": "auf Version {version}",
  "updateScreen.row.already": "bereits auf Version {version}",
  "updateScreen.row.building": "erstellt {version}",
  "updateScreen.row.restarting": "offline, Neustart in {elapsed}",
  "updateScreen.row.restartingNote": "Absichtlich entfernt. Das Update wird ohne dieses Element fortgesetzt.",
  "updateScreen.row.waitsFor": "wartet auf {name}",
  "updateScreen.row.nextInLine": "als Nächstes an der Reihe",
  "updateScreen.row.limited": "wartend",
  "updateScreen.row.quiet": "keine Antwort seit {elapsed}",
  "updateScreen.row.noAnswer": "keine Antwort",
  "updateScreen.row.backOn": "wieder auf Version {version}",
  "updateScreen.row.stuck": "hängt",
  "updateScreen.row.stopped": "angehalten",
  "updateScreen.row.failed": "fehlgeschlagen",
  "updateScreen.row.skipped": "übersprungen",
  "updateScreen.row.stillOn": "Weiterhin auf Version {version}.",
  "updateScreen.row.untouched": "nicht angetastet",
  "updateScreen.row.packageManaged": "wird über die zugehörige Paketverwaltung aktualisiert",
  "updateScreen.row.phoneWaits": "wartet, bis es an der Reihe ist",
  "updateScreen.row.phoneLooking": "lädt die neue Anwendung herunter",
  "updateScreen.row.phoneDownloading": "wird heruntergeladen",
  "updateScreen.row.files": "{done} von {total} Dateien",
  "updateScreen.row.phoneHung": "keine neue Datei",
  "updateScreen.row.phoneReloading": "wird neu geladen",
  "updateScreen.row.phoneKeeps": "behält diese App",
  "updateScreen.row.phoneKept": "behält vorerst ihre App",
  "updateScreen.row.phoneKeptNote": "Die neue App wird beim nächsten Start von Collie geladen.",
  "updateScreen.row.reading": "liest ihren Status",
  "updateScreen.reading.subtitle": "Liest den Fortschritt der Aktualisierung. Dies dauert einen Moment.",

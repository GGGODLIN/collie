...
export const en = {
  ...
  "retell.plain": "Plain",
  "retell.lost": "Lost",
  "retell.loading": "Writing the retelling — this can take a minute",
  "retell.failed": "Couldn't retell this session",
  "retell.cached": "From the shared cache",
  "retell.again": "Ask again",
  "paneActions.account.label": "Switch account",
  "paneActions.account.back": "Back",
  "paneActions.account.switching": "Switching to {account}…",
  "paneActions.account.confirmInterrupt": "Tap again to interrupt this turn and switch to {account}",
  "paneActions.account.done": "Resumed on {account}",
  "paneActions.account.failed": "Couldn't switch account",
  ...
  "apiError.account.not_allowlisted": "That account isn't in your accounts.toml",
  "apiError.account.not_claude": "This pane isn't running a Claude session Collie can resume",
  "apiError.account.confirm_interrupt": "The agent is working — confirm interrupting this turn",
  "apiError.account.in_progress": "A switch is already running on this pane",
  "apiError.account.no_transcript": "This session has no transcript yet — send one message first",
  "apiError.account.settings_pending": "The model or effort changed since the last answer — send one message first",
  "apiError.account.exit_failed": "{reason}",
  "apiError.account.exit_unconfirmed": "Claude didn't confirm it exited, so nothing was started — check the pane",
  "apiError.account.launch_failed": "{reason}",
